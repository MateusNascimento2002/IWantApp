...
public class ProductPost
{
    ...
    public static async Task<IResult> Action(ProductRequest productRequest, HttpContext http, ApplicationDbContext context)
    {
        ...
        var product = new Product(productRequest.Name, productRequest.CategoryId, category, productRequest.Description, productRequest.HasStock, productRequest.Active, productRequest.Price, userId);
